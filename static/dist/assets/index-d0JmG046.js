...
`:"";t.isRawShaderMaterial?(h=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(rr).join(`
`),h.length>0&&(h+=`
...
Parsed:`,l),i++)}catch(l){console.error(`Error parsing or adding remote ICE candidate: "${o}"`,l),i++}}let s="Status: ";r===0?s+="No ICE candidates found in input.":(s+=`Processed ${r} candidate(s). Added: ${t}. Failed: ${i}.`,i>0&&(s+=" Check console for details.")),we.textContent=s,console.log(s),(t>0||r>0)&&(ur.value="")}function u_(){if(Pe&&Pe.readyState==="open"&&dt.isLocked&&!pt){const n=dt.getObject(),e={position:{x:n.position.x,y:n.position.y,z:n.position.z},quaternion:{x:nt.quaternion.x,y:nt.quaternion.y,z:nt.quaternion.z,w:nt.quaternion.w},aiming:Bn||On,weaponType:it};try{Pe.send(JSON.stringify({type:"playerState",data:e}))}catch(t){console.error("Error sending player state:",t)}}}function Ni(n){if(Pe&&Pe.readyState==="open")try{Pe.send(JSON.stringify({type:"gameEvent",data:n}))}catch(e){console.error("Error sending game event:",e,`
Event:`,n)}}function d_(){if(!dt||!ue||en.length===0||!j)return;const n=dt.getObject();let e;if($e==="multiplayer"&&je&&je.parent){const t=new R;je.getWorldPosition(t),e=Yr(en,t,50)}else e=Yr(en);n.position.copy(e),n.rotation.y=0,wt&&(wt.rotation.x=0),fn.set(0,0,0),Os("RESPAWNED!",1500)}function Ro(n){if(pt)return;pt=!0,Sn=!1,dt.unlock(),console.log(`Game Over. Player ${n?"WON":"LOST"}. My PlayerOne status: ${vt}`);const e=n?"YOU WIN!":"YOU LOSE!";if(tn&&Qt&&(tn.style.display="flex",Qt.textContent=e,ht&&(ht.style.display="none")),Pe&&Pe.readyState==="open"){const t={winnerIsPlayerOne:n?vt:vt===null?null:!vt};console.log("Sending game_over_notif, data:",t),Ni({type:"game_over_notif",data:t})}setTimeout(()=>{$e="idle",jt&&(jt.style.display="flex"),Ii&&(Ii.style.display="none"),tn&&Qt&&(tn.style.display="none",Qt.textContent="Click to Start"),tt&&(tt.style.display="none")},5e3)}function h_(){!nt||!pn||(nt.aspect=window.innerWidth/window.innerHeight,nt.updateProjectionMatrix(),pn.setSize(window.innerWidth,window.innerHeight))}function yt(n){wi.push({timestamp:performance.now(),action:n})}function f_(n){if(!(!dt||!dt.isLocked||pt))switch(n.code){case"KeyW":case"ArrowUp":yt(()=>vr=!0);break;case"KeyA":case"ArrowLeft":yt(()=>Sr=!0);break;case"KeyS":case"ArrowDown":yt(()=>xr=!0);break;case"KeyD":case"ArrowRight":yt(()=>Mr=!0);break;case"ShiftLeft":yt(()=>On=!0);break;case"Digit1":yt(()=>Gr("handgun"));break;case"Digit2":yt(()=>Gr("sniper"));break;case"Digit3":yt(()=>Gr("smg"));break;case"KeyR":yt(()=>Jg());break;case"PageUp":yt(()=>Gl(25));break;case"PageDown":yt(()=>Gl(-25));break}}function p_(n){if(pt){n.code==="ShiftLeft"&&yt(()=>On=!1);return}switch(n.code){case"KeyW":case"ArrowUp":yt(()=>vr=!1);break;case"KeyA":case"ArrowLeft":yt(()=>Sr=!1);break;case"KeyS":case"ArrowDown":yt(()=>xr=!1);break;case"KeyD":case"ArrowRight":yt(()=>Mr=!1);break;case"ShiftLeft":yt(()=>On=!1);break}}function m_(n){if(!(!dt||!dt.isLocked||pt||!j))if(n.button===0)if(it==="smg")Sn=!0;else{const e=performance.now(),t=at[it];if(!t||!t.fireRate||e-cr<t.fireRate)return;yt(()=>{if(pt)return;const i=performance.now();if(i-cr<t.fireRate)return;cr=i;const r=new R;if(t.muzzlePoint.getWorldPosition(r),Nn[it]<=0||Zn)return;const s=new R;if(nt.getWorldDirection(s),Cc(r,s.clone(),it),Nn[it]--,$e==="multiplayer"){const a={muzzlePosition:{x:r.x,y:r.y,z:r.z},direction:{x:s.x,y:s.y,z:s.z},weaponType:it};Ni({type:"shoot",data:a})}t.model&&!fi&&(fi=!0,Yn=0)})}else n.button===2&&yt(()=>Bn=!0)}function g_(n){if(pt){n.button===2&&yt(()=>Bn=!1);return}n.button===0?Sn&&(Sn=!1):n.button===2&&yt(()=>Bn=!1)}function Cc(n,e,t){if(!ue||!at[t]||!nt||!j)return;const i=at[t],r=e.clone();if(t==="smg"&&i.spreadAngle&&i.projectileMaterial){const l=(Bn||On)&&i.adsSpreadMultiplier!==void 0?i.adsSpreadMultiplier:1,c=i.spreadAngle*l;if(c>.001){const u=nt.quaternion,d=new R(1,0,0).applyQuaternion(u),f=new R(0,1,0).applyQuaternion(u),m=j.next()*2*Math.PI,g=Math.tan(c/2),_=j.next()*g,p=Math.cos(m)*_,h=Math.sin(m)*_;r.addScaledVector(d,p),r.addScaledVector(f,h),r.normalize()}}if(t==="sniper"&&i.projectileSpeed){const o=Kg(sr,i.projectileSpeed),l=nt.quaternion.clone(),c=new R(0,1,0).applyQuaternion(l);r.addScaledVector(c,Math.sin(o)),r.normalize()}const s=new Re(yc,i.projectileMaterial);s.castShadow=!0,s.position.copy(n);const a={mesh:s,velocity:r.multiplyScalar(i.projectileSpeed),lifeTime:0,spawnTime:performance.now(),weaponType:t};ue.add(a.mesh),bi.push(a)}const Jt=new jo,or=new R;function __(n){if(ue)for(let e=bi.length-1;e>=0;e--){const t=bi[e],i=t.mesh.position.clone();if(t.velocity.y-=Qo*n,t.mesh.position.addScaledVector(t.velocity,n),t.lifeTime+=n,t.lifeTime>Ec){ue.remove(t.mesh),t.mesh.geometry&&t.mesh.geometry.dispose(),bi.splice(e,1);continue}Jt.origin.copy(i),Jt.direction.copy(t.mesh.position).sub(i);const r=Jt.direction.length();r>=1e-4&&Jt.direction.normalize();let s=!1;for(const[a,o]of _r.entries()){const c=new _t().setFromObject(o).clone().expandByScalar(Ns);let u=!1;if(r>=1e-4){const d=Jt.intersectBox(c,or);d&&i.distanceTo(d)<=r&&(u=!0)}if(u||c.containsPoint(t.mesh.position)){ue.remove(o),o.geometry&&o.geometry.dispose(),o.material&&!Array.isArray(o.material)&&o.material.dispose(),_r.delete(a),s=!0;break}}if(!s&&$e==="multiplayer"&&je&&je.parent){const o=new _t().setFromObject(je).clone().expandByScalar(an);let l=!1;if(r>=1e-4){const c=Jt.intersectBox(o,or);c&&i.distanceTo(c)<=r&&(l=!0)}if(l||o.containsPoint(t.mesh.position)){const c=at[t.weaponType];c&&typeof c.damage=="number"?Ni({type:"hit_opponent",data:{damageDealt:c.damage}}):Ni({type:"hit_opponent",data:{damageDealt:1}}),s=!0,je.traverse(u=>{if(u instanceof Re&&u.material instanceof Ft){const d=u.material.color.getHex();u.material.color.setHex(16711680),setTimeout(()=>{u&&u.material instanceof Ft&&u.material.color.setHex(d)},150)}})}}if(!s)for(const a of ut){const o=new _t().setFromObject(a),l=Ns;o.expandByScalar(l);let c=!1;if(r>=1e-4){const u=Jt.intersectBox(o,or);u&&i.distanceTo(u)<=r&&(c=!0)}if(c||o.containsPoint(t.mesh.position)){s=!0;break}}if(!s&&ln){const a=new _t().setFromObject(ln);let o=!1;if(r>=1e-4){const l=Jt.intersectBox(a,or);l&&i.distanceTo(l)<=r&&(o=!0)}(o||a.containsPoint(t.mesh.position))&&(s=!0)}s&&(ue.remove(t.mesh),t.mesh.geometry&&t.mesh.geometry.dispose(),bi.splice(e,1))}}function v_(n){if(ue)for(let e=Ai.length-1;e>=0;e--){const t=Ai[e],i=t.mesh.position.clone();if(t.velocity.y-=Qo*n,t.mesh.position.addScaledVector(t.velocity,n),t.lifeTime+=n,t.lifeTime>Ec){ue.remove(t.mesh),t.mesh.geometry&&t.mesh.geometry.dispose(),Ai.splice(e,1);continue}let r=!1;Jt.origin.copy(i),Jt.direction.copy(t.mesh.position).sub(i);const s=Jt.direction.length();s>=1e-4&&Jt.direction.normalize();for(const a of ut){const o=new _t().setFromObject(a);o.expandByScalar(Ns);let l=!1;if(s>=1e-4){const c=Jt.intersectBox(o,or);c&&i.distanceTo(c)<=s&&(l=!0)}if(l||o.containsPoint(t.mesh.position)){r=!0;break}}if(!r&&ln){const a=new _t().setFromObject(ln);let o=!1;if(s>=1e-4){const l=Jt.intersectBox(a,or);l&&i.distanceTo(l)<=s&&(o=!0)}(o||a.containsPoint(t.mesh.position))&&(r=!0)}r&&(ue.remove(t.mesh),t.mesh.geometry&&t.mesh.geometry.dispose(),Ai.splice(e,1))}}function x_(n){if(!nt||!at[it]||!ui||!Wr||!ci||!Xr||!j)return;const e=at[it],t=e.model,i=Bn||On,r=i?e.adsFov:ea;nt.fov=Si.lerp(nt.fov,r,Dr*n),nt.updateProjectionMatrix();const s=ci.getObjectByName("sniperScopeMesh");if(it==="sniper"?(ui.style.display=i?"block":"none",s&&ci.visible&&(s.visible=!i)):ui.style.display="none",fi){Yn+=n;let l=0;const c=new R;if(Yn<=e.recoilDuration)if(c.x=(j.next()-.5)*2*(e.recoilAmount.x||0),c.z=e.recoilAmount.z,it==="sniper"&&i)l=e.recoilAmount.y;else{c.y=e.recoilAmount.y;let f=.015;it==="sniper"?f=.02:it==="smg"&&(f=.025),l=f}const u=e.recoilReturnSpeed*n,d=Yn<=e.recoilDuration?u*2.5:u*1.5;if(mn=Si.lerp(mn,l,d),Tn.lerp(c,d),Yn>e.recoilDuration){const f=Math.abs(mn)<.001&&Math.abs(l)<.001,m=Tn.lengthSq()<1e-5&&c.lengthSq()<1e-5;f&&m&&(fi=!1,Yn=0,mn=0,Tn.set(0,0,0))}}else mn=Si.lerp(mn,0,e.recoilReturnSpeed*n*1.5),Tn.lerp(new R(0,0,0),e.recoilReturnSpeed*n*1.5);const a=i?e.adsPosition:e.hipPosition,o=i?e.adsRotation:e.hipRotation;if(t.position.lerp(a,Dr*n),t.rotation.x=Si.lerp(t.rotation.x,o.x,Dr*n),t.rotation.y=Si.lerp(t.rotation.y,o.y,Dr*n),t.rotation.z=Si.lerp(t.rotation.z,o.z,Dr*n),it==="sniper"&&i?(t.rotation.x+=mn,t.position.x-=Tn.x,t.position.z-=Tn.z):(t.position.x-=Tn.x,t.position.y-=Tn.y,t.position.z-=Tn.z),Zn&&e.reloadTime){bs+=n;const l=Math.min(bs/(e.reloadTime/1e3),1),c=Math.sin(l*Math.PI),u=Math.sin(l*Math.PI*2)*.5;nr.y=-.25*c,nr.z=.15*u,nr.x=Math.sin(l*Math.PI*3)*.05,t.position.add(nr)}else Zn||(bs=0,nr.set(0,0,0))}function S_(){const n=performance.now();let e=0;for(;e<wi.length;)n>=wi[e].timestamp+hg?(wi[e].action(),wi.splice(e,1)):e++}const ys=new _t;function ko(){if(!qr||!pn||!ue||!nt||!dt){if($e==="idle"&&qr&&(!(jt!=null&&jt.style.display)||(jt==null?void 0:jt.style.display)==="flex")){Ee&&!pt&&jr();return}requestAnimationFrame(ko);return}if(requestAnimationFrame(ko),pt){pn.render(ue,nt);return}const n=performance.now(),e=dt.isLocked?Math.min((n-Is)/1e3,.05):0;if(Is=n,dt.isLocked){if(S_(),Sn&&it==="smg"&&!pt&&j){const d=at.smg;if(d&&d.fireRate&&n-cr>=d.fireRate){cr=n;const f=new R;if(d.muzzlePoint.getWorldPosition(f),Nn.smg<=0||Zn){Sn=!1;return}const m=new R;if(nt.getWorldDirection(m),Cc(f,m.clone(),"smg"),Nn.smg--,$e==="multiplayer"){const g={muzzlePosition:{x:f.x,y:f.y,z:f.z},direction:{x:m.x,y:m.y,z:m.z},weaponType:"smg"};Ni({type:"shoot",data:g})}d.model&&!fi&&(fi=!0,Yn=0)}}if(Zn){const d=at[it];d&&d.reloadTime&&n-ta>=d.reloadTime&&(Nn[it]=d.magazineCapacity||0,Zn=!1,bs=0,nr.set(0,0,0))}const t=dt.getObject(),i=fg*(On||Bn?.6:1);fn.x-=fn.x*10*e,fn.z-=fn.z*10*e,Lr.z=Number(vr)-Number(xr),Lr.x=Number(Sr)-Number(Mr),Lr.normalize(),(vr||xr)&&(fn.z-=Lr.z*i*10*e),(Sr||Mr)&&(fn.x-=Lr.x*i*10*e);const r=new R;r.x=fn.x*e,r.z=fn.z*e;const s=t.position.clone();t.translateX(r.x),ys.setFromCenterAndSize(new R(t.position.x,s.y-ct/2+an,t.position.z),new R(an*2,ct-an*2,an*2));for(const d of ut){const f=new _t().setFromObject(d);if(ys.intersectsBox(f)){t.position.x=s.x,fn.x=0;break}}t.translateZ(r.z),ys.setFromCenterAndSize(new R(t.position.x,s.y-ct/2+an,t.position.z),new R(an*2,ct-an*2,an*2));for(const d of ut){const f=new _t().setFromObject(d);if(ys.intersectsBox(f)){t.position.z=s.z,fn.z=0;break}}const a=t.position.clone();a.y+=ct*.5;const o=new R(0,-1,0),l=new Mc(a,o,0,ct*2),c=[ln,...ut.filter(d=>new _t().setFromObject(d).max.y<a.y+ct*.5)],u=l.intersectObjects(c,!1);if(u.length>0){const d=u[0];t.position.y=d.point.y+ct}else t.position.y-=9.81*e*e*2;if(wt){let f=wt.rotation.x-mn;wt.rotation.x=Math.max(-Math.PI/2,Math.min(Math.PI/2,f))}$e==="multiplayer"&&n-Ol>Lg&&(u_(),Ol=n)}else if(fn.set(0,0,0),wt&&mn!==0){let i=wt.rotation.x-mn;wt.rotation.x=Math.max(-Math.PI/2,Math.min(Math.PI/2,i))}x_(e),__(e),$e==="multiplayer"&&v_(e),Rc(),pn.render(ue,nt)}qg();
