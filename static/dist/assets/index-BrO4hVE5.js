...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function ol(){return new Pi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function al(){return new Pi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xo(),fragmentShader:`
	...
	`}function tp(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,c=l===To||l===bo,u=l===cr||l===ur;if(c||u)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let d=e.get(o);return t===null&&(t=new rl(n)),d=c?t.fromEquirectangular(o,d):t.fromCubemap(o,d),e.set(o,d),d.texture}else{if(e.has(o))return e.get(o).texture;{const d=o.image;if(c&&d&&d.height>0||u&&d&&r(d)){t===null&&(t=new rl(n));const f=c?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,f),o.addEventListener("dispose",s),f.texture}else return null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function np(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(i){i.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(i){const r=t(i);return r===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function ip(n,e,t,i){const r={},s=new WeakMap;function a(d){const f=d.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let p=0,h=_.length;p<h;p++)e.remove(_[p])}f.removeEventListener("dispose",a),delete r[f.id];const m=s.get(f);m&&(e.remove(m),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(d,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function l(d){const f=d.attributes;for(const g in f)e.update(f[g],n.ARRAY_BUFFER);const m=d.morphAttributes;for(const g in m){const _=m[g];for(let p=0,h=_.length;p<h;p++)e.update(_[p],n.ARRAY_BUFFER)}}function c(d){const f=[],m=d.index,g=d.attributes.position;let _=0;if(m!==null){const T=m.array;_=m.version;for(let E=0,b=T.length;E<b;E+=3){const L=T[E+0],w=T[E+1],A=T[E+2];f.push(L,w,w,A,A,L)}}else if(g!==void 0){const T=g.array;_=g.version;for(let E=0,b=T.length/3-1;E<b;E+=3){const L=E+0,w=E+1,A=E+2;f.push(L,w,w,A,A,L)}}else return;const p=new(Yl(f)?Ql:Jl)(f,1);p.version=_;const h=s.get(d);h&&e.remove(h),s.set(d,p)}function u(d){const f=s.get(d);if(f){const m=d.index;m!==null&&f.version<m.version&&c(d)}else c(d);return s.get(d)}return{get:o,update:l,getWireframeAttribute:u}}function rp(n,e,t,i){const r=i.isWebGL2;let s;function a(m){s=m}let o,l;function c(m){o=m.type,l=m.bytesPerElement}function u(m,g){n.drawElements(s,g,o,m*l),t.update(g,s,1)}function d(m,g,_){if(_===0)return;let p,h;if(r)p=n,h="drawElementsInstanced";else if(p=e.get("ANGLE_instanced_arrays"),h="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[h](s,g,o,m*l,_),t.update(g,s,_)}function f(m,g,_){if(_===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<_;h++)this.render(m[h]/l,g[h]);else{p.multiDrawElementsWEBGL(s,g,0,o,m,0,_);let h=0;for(let T=0;T<_;T++)h+=g[T];t.update(h,s,1)}}this.setMode=a,this.setIndex=c,this.render=u,this.renderInstances=d,this.renderMultiDraw=f}function sp(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function op(n,e){return n[0]-e[0]}function ap(n,e){return Math.abs(e[1])-Math.abs(n[1])}function lp(n,e,t){const i={},r=new Float32Array(8),s=new WeakMap,a=new Ut,o=[];for(let c=0;c<8;c++)o[c]=[c,0];function l(c,u,d){const f=c.morphTargetInfluences;if(e.isWebGL2===!0){const g=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,_=g!==void 0?g.length:0;let p=s.get(u);if(p===void 0||p.count!==_){let O=function(){ee.dispose(),s.delete(u),u.removeEventListener("dispose",O)};var m=O;p!==void 0&&p.texture.dispose();const E=u.morphAttributes.position!==void 0,b=u.morphAttributes.normal!==void 0,L=u.morphAttributes.color!==void 0,w=u.morphAttributes.position||[],A=u.morphAttributes.normal||[],V=u.morphAttributes.color||[];let S=0;E===!0&&(S=1),b===!0&&(S=2),L===!0&&(S=3);let y=u.attributes.position.count*S,z=1;y>e.maxTextureSize&&(z=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const k=new Float32Array(y*z*4*_),ee=new Zl(k,y,z,_);ee.type=ii,ee.needsUpdate=!0;const P=S*4;for(let H=0;H<_;H++){const q=w[H],W=A[H],X=V[H],j=y*z*4*H;for(let te=0;te<q.count;te++){const ne=te*P;E===!0&&(a.fromBufferAttribute(q,te),k[j+ne+0]=a.x,k[j+ne+1]=a.y,k[j+ne+2]=a.z,k[j+ne+3]=0),b===!0&&(a.fromBufferAttribute(W,te),k[j+ne+4]=a.x,k[j+ne+5]=a.y,k[j+ne+6]=a.z,k[j+ne+7]=0),L===!0&&(a.fromBufferAttribute(X,te),k[j+ne+8]=a.x,k[j+ne+9]=a.y,k[j+ne+10]=a.z,k[j+ne+11]=X.itemSize===4?a.w:1)}}p={count:_,texture:ee,size:new Ze(y,z)},s.set(u,p),u.addEventListener("dispose",O)}let h=0;for(let E=0;E<f.length;E++)h+=f[E];const T=u.morphTargetsRelative?1:1-h;d.getUniforms().setValue(n,"morphTargetBaseInfluence",T),d.getUniforms().setValue(n,"morphTargetInfluences",f),d.getUniforms().setValue(n,"morphTargetsTexture",p.texture,t),d.getUniforms().setValue(n,"morphTargetsTextureSize",p.size)}else{const g=f===void 0?0:f.length;let _=i[u.id];if(_===void 0||_.length!==g){_=[];for(let b=0;b<g;b++)_[b]=[b,0];i[u.id]=_}for(let b=0;b<g;b++){const L=_[b];L[0]=b,L[1]=f[b]}_.sort(ap);for(let b=0;b<8;b++)b<g&&_[b][1]?(o[b][0]=_[b][0],o[b][1]=_[b][1]):(o[b][0]=Number.MAX_SAFE_INTEGER,o[b][1]=0);o.sort(op);const p=u.morphAttributes.position,h=u.morphAttributes.normal;let T=0;for(let b=0;b<8;b++){const L=o[b],w=L[0],A=L[1];w!==Number.MAX_SAFE_INTEGER&&A?(p&&u.getAttribute("morphTarget"+b)!==p[w]&&u.setAttribute("morphTarget"+b,p[w]),h&&u.getAttribute("morphNormal"+b)!==h[w]&&u.setAttribute("morphNormal"+b,h[w]),r[b]=A,T+=A):(p&&u.hasAttribute("morphTarget"+b)===!0&&u.deleteAttribute("morphTarget"+b),h&&u.hasAttribute("morphNormal"+b)===!0&&u.deleteAttribute("morphNormal"+b),r[b]=0)}const E=u.morphTargetsRelative?1:1-T;d.getUniforms().setValue(n,"morphTargetBaseInfluence",E),d.getUniforms().setValue(n,"morphTargetInfluences",r)}}return{update:l}}function cp(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,u=l.geometry,d=e.get(l,u);if(r.get(d)!==c&&(e.update(d),r.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return d}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}class sc extends on{constructor(e,t,i,r,s,a,o,l,c,u){if(u=u!==void 0?u:Ai,u!==Ai&&u!==dr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===Ai&&(i=ni),i===void 0&&u===dr&&(i=bi),super(null,r,s,a,o,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:qt,this.minFilter=l!==void 0?l:qt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const oc=new on,ac=new sc(1,1);ac.compareFunction=ql;const lc=new Zl,cc=new qu,uc=new nc,ll=[],cl=[],ul=new Float32Array(16),dl=new Float32Array(9),hl=new Float32Array(4);function Er(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=ll[r];if(s===void 0&&(s=new Float32Array(r),ll[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function Rt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Ct(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Ns(n,e){let t=cl[e];t===void 0&&(t=new Int32Array(e),cl[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function up(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function dp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;n.uniform2fv(this.addr,e),Ct(t,e)}}function hp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Rt(t,e))return;n.uniform3fv(this.addr,e),Ct(t,e)}}function fp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;n.uniform4fv(this.addr,e),Ct(t,e)}}function pp(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Rt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Ct(t,e)}else{if(Rt(t,i))return;hl.set(i),n.uniformMatrix2fv(this.addr,!1,hl),Ct(t,i)}}function mp(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Rt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Ct(t,e)}else{if(Rt(t,i))return;dl.set(i),n.uniformMatrix3fv(this.addr,!1,dl),Ct(t,i)}}function gp(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Rt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Ct(t,e)}else{if(Rt(t,i))return;ul.set(i),n.uniformMatrix4fv(this.addr,!1,ul),Ct(t,i)}}function _p(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function vp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;n.uniform2iv(this.addr,e),Ct(t,e)}}function xp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Rt(t,e))return;n.uniform3iv(this.addr,e),Ct(t,e)}}function Sp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;n.uniform4iv(this.addr,e),Ct(t,e)}}function Mp(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Ep(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;n.uniform2uiv(this.addr,e),Ct(t,e)}}function yp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Rt(t,e))return;n.uniform3uiv(this.addr,e),Ct(t,e)}}function Tp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;n.uniform4uiv(this.addr,e),Ct(t,e)}}function bp(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);const s=this.type===n.SAMPLER_2D_SHADOW?ac:oc;t.setTexture2D(e||s,r)}function Ap(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||cc,r)}function wp(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||uc,r)}function Rp(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||lc,r)}function Cp(n){switch(n){case 5126:return up;case 35664:return dp;case 35665:return hp;case 35666:return fp;case 35674:return pp;case 35675:return mp;case 35676:return gp;case 5124:case 35670:return _p;case 35667:case 35671:return vp;case 35668:case 35672:return xp;case 35669:case 35673:return Sp;case 5125:return Mp;case 36294:return Ep;case 36295:return yp;case 36296:return Tp;case 35678:case 36198:case 36298:case 36306:case 35682:return bp;case 35679:case 36299:case 36307:return Ap;case 35680:case 36300:case 36308:case 36293:return wp;case 36289:case 36303:case 36311:case 36292:return Rp}}function Pp(n,e){n.uniform1fv(this.addr,e)}function Lp(n,e){const t=Er(e,this.size,2);n.uniform2fv(this.addr,t)}function Dp(n,e){const t=Er(e,this.size,3);n.uniform3fv(this.addr,t)}function Up(n,e){const t=Er(e,this.size,4);n.uniform4fv(this.addr,t)}function Ip(n,e){const t=Er(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Np(n,e){const t=Er(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Fp(n,e){const t=Er(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Op(n,e){n.uniform1iv(this.addr,e)}function Bp(n,e){n.uniform2iv(this.addr,e)}function zp(n,e){n.uniform3iv(this.addr,e)}function Gp(n,e){n.uniform4iv(this.addr,e)}function Hp(n,e){n.uniform1uiv(this.addr,e)}function kp(n,e){n.uniform2uiv(this.addr,e)}function Vp(n,e){n.uniform3uiv(this.addr,e)}function Wp(n,e){n.uniform4uiv(this.addr,e)}function Xp(n,e,t){const i=this.cache,r=e.length,s=Ns(t,r);Rt(i,s)||(n.uniform1iv(this.addr,s),Ct(i,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||oc,s[a])}function qp(n,e,t){const i=this.cache,r=e.length,s=Ns(t,r);Rt(i,s)||(n.uniform1iv(this.addr,s),Ct(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||cc,s[a])}function Yp(n,e,t){const i=this.cache,r=e.length,s=Ns(t,r);Rt(i,s)||(n.uniform1iv(this.addr,s),Ct(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||uc,s[a])}function jp(n,e,t){const i=this.cache,r=e.length,s=Ns(t,r);Rt(i,s)||(n.uniform1iv(this.addr,s),Ct(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||lc,s[a])}function $p(n){switch(n){case 5126:return Pp;case 35664:return Lp;case 35665:return Dp;case 35666:return Up;case 35674:return Ip;case 35675:return Np;case 35676:return Fp;case 5124:case 35670:return Op;case 35667:case 35671:return Bp;case 35668:case 35672:return zp;case 35669:case 35673:return Gp;case 5125:return Hp;case 36294:return kp;case 36295:return Vp;case 36296:return Wp;case 35678:case 36198:case 36298:case 36306:case 35682:return Xp;case 35679:case 36299:case 36307:return qp;case 35680:case 36300:case 36308:case 36293:return Yp;case 36289:case 36303:case 36311:case 36292:return jp}}class Zp{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Cp(t.type)}}class Kp{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=$p(t.type)}}class Jp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const go=/(\w+)(\])?(\[|\.)?/g;function fl(n,e){n.seq.push(e),n.map[e.id]=e}function Qp(n,e,t){const i=n.name,r=i.length;for(go.lastIndex=0;;){const s=go.exec(i),a=go.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){fl(t,c===void 0?new Zp(o,n,e):new Kp(o,n,e));break}else{let d=t.map[o];d===void 0&&(d=new Jp(o),fl(t,d)),t=d}}}class Ms{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);Qp(s,a,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function pl(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const em=37297;let tm=0;function nm(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}function im(n){const e=et.getPrimaries(et.workingColorSpace),t=et.getPrimaries(n);let i;switch(e===t?i="":e===As&&t===bs?i="LinearDisplayP3ToLinearSRGB":e===bs&&t===As&&(i="LinearSRGBToLinearDisplayP3"),n){case $n:case Us:return[i,"LinearTransferOETF"];case It:case zo:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function ml(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+nm(n.getShaderSource(e),a)}else return r}function rm(n,e){const t=im(e);return`vec4 ${n}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function sm(n,e){let t;switch(e){case nu:t="Linear";break;case iu:t="Reinhard";break;case ru:t="OptimizedCineon";break;case su:t="ACESFilmic";break;case au:t="AgX";break;case ou:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function om(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(nr).join(`
`)}function am(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(nr).join(`
`)}function lm(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function cm(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),a=s.name;let o=1;s.type===n.FLOAT_MAT2&&(o=2),s.type===n.FLOAT_MAT3&&(o=3),s.type===n.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function nr(n){return n!==""}function gl(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function _l(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const um=/^[ \t]*#include +<([\w\d./]+)>/gm;function Po(n){return n.replace(um,hm)}const dm=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function hm(n,e){let t=Oe[e];if(t===void 0){const i=dm.get(e);if(i!==void 0)t=Oe[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Po(t)}const fm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function vl(n){return n.replace(fm,pm)}function pm(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function xl(n){let e="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?e+=`
#define HIGH_PRECISION`:n.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function mm(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Ul?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Il?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===kn&&(e="SHADOWMAP_TYPE_VSM"),e}function gm(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case cr:case ur:e="ENVMAP_TYPE_CUBE";break;case Ds:e="ENVMAP_TYPE_CUBE_UV";break}return e}function _m(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case ur:e="ENVMAP_MODE_REFRACTION";break}return e}function vm(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Nl:e="ENVMAP_BLENDING_MULTIPLY";break;case eu:e="ENVMAP_BLENDING_MIX";break;case tu:e="ENVMAP_BLENDING_ADD";break}return e}function xm(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function Sm(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=mm(t),c=gm(t),u=_m(t),d=vm(t),f=xm(t),m=t.isWebGL2?"":om(t),g=am(t),_=lm(s),p=r.createProgram();let h,T,E=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(h=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(nr).join(`
`),h.length>0&&(h+=`
`),T=[m,"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(nr).join(`
`),T.length>0&&(T+=`
...
`].filter(nr).join(`
`),T=[m,xl(t),"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_,t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.map?"#define USE_MAP":"",t.matcap?"#define USE_MATCAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+c:"",t.envMap?"#define "+u:"",t.envMap?"#define "+d:"",f?"#define CUBEUV_TEXEL_WIDTH "+f.texelWidth:"",f?"#define CUBEUV_TEXEL_HEIGHT "+f.texelHeight:"",f?"#define CUBEUV_MAX_MIP "+f.maxMip+".0":"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",t.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.anisotropy?"#define USE_ANISOTROPY":"",t.anisotropyMap?"#define USE_ANISOTROPYMAP":"",t.clearcoat?"#define USE_CLEARCOAT":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.iridescence?"#define USE_IRIDESCENCE":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",t.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.alphaTest?"#define USE_ALPHATEST":"",t.alphaHash?"#define USE_ALPHAHASH":"",t.sheen?"#define USE_SHEEN":"",t.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.vertexTangents&&t.flatShading===!1?"#define USE_TANGENT":"",t.vertexColors||t.instancingColor?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUv1s?"#define USE_UV1":"",t.vertexUv2s?"#define USE_UV2":"",t.vertexUv3s?"#define USE_UV3":"",t.pointsUvs?"#define USE_POINTS_UV":"",t.gradientMap?"#define USE_GRADIENTMAP":"",t.flatShading?"#define FLAT_SHADED":"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+l:"",t.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",t.numLightProbes>0?"#define USE_LIGHT_PROBES":"",t.useLegacyLights?"#define LEGACY_LIGHTS":"",t.decodeVideoTexture?"#define DECODE_VIDEO_TEXTURE":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"",t.logarithmicDepthBuffer&&t.rendererExtensionFragDepth?"#define USE_LOGDEPTHBUF_EXT":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",t.toneMapping!==si?"#define TONE_MAPPING":"",t.toneMapping!==si?Oe.tonemapping_pars_fragment:"",t.toneMapping!==si?sm("toneMapping",t.toneMapping):"",t.dithering?"#define DITHERING":"",t.opaque?"#define OPAQUE":"",Oe.colorspace_pars_fragment,rm("linearToOutputTexel",t.outputColorSpace),t.useDepthPacking?"#define DEPTH_PACKING "+t.depthPacking:"",`
`].filter(nr).join(`
`)),a=Po(a),a=gl(a,t),a=_l(a,t),o=Po(o),o=gl(o,t),o=_l(o,t),a=vl(a),o=vl(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
Parsed:`,l),i++)}catch(l){console.error(`Error parsing or adding remote ICE candidate: "${o}"`,l),i++}}let s="Status: ";r===0?s+="No ICE candidates found in input.":(s+=`Processed ${r} candidate(s). Added: ${t}. Failed: ${i}.`,i>0&&(s+=" Check console for details.")),we.textContent=s,console.log(s),(t>0||r>0)&&(ar.value="")}function i_(){if(Pe&&Pe.readyState==="open"&&ct.isLocked&&!ht){const n=ct.getObject(),e={position:{x:n.position.x,y:n.position.y,z:n.position.z},quaternion:{x:nt.quaternion.x,y:nt.quaternion.y,z:nt.quaternion.z,w:nt.quaternion.w},aiming:Nn||In,weaponType:at};try{Pe.send(JSON.stringify({type:"playerState",data:e}))}catch(t){console.error("Error sending player state:",t)}}}function Ui(n){if(Pe&&Pe.readyState==="open")try{Pe.send(JSON.stringify({type:"gameEvent",data:n}))}catch(e){console.error("Error sending game event:",e,`
Event:`,n)}}function r_(){if(!ct||!ue||Qt.length===0||!Y)return;const n=ct.getObject();let e;if($e==="multiplayer"&&je&&je.parent){const t=new C;je.getWorldPosition(t),e=Wr(Qt,t,50)}else e=Wr(Qt);n.position.copy(e),n.rotation.y=0,bt&&(bt.rotation.x=0),un.set(0,0,0),Io("RESPAWNED!",1500)}function Mo(n){if(ht)return;ht=!0,_n=!1,ct.unlock(),console.log(`Game Over. Player ${n?"WON":"LOST"}. My PlayerOne status: ${mt}`);const e=n?"YOU WIN!":"YOU LOSE!";if(en&&Jt&&(en.style.display="flex",Jt.textContent=e,ut&&(ut.style.display="none")),Pe&&Pe.readyState==="open"){const t={winnerIsPlayerOne:n?mt:mt===null?null:!mt};console.log("Sending game_over_notif, data:",t),Ui({type:"game_over_notif",data:t})}setTimeout(()=>{$e="idle",jt&&(jt.style.display="flex"),Di&&(Di.style.display="none"),en&&Jt&&(en.style.display="none",Jt.textContent="Click to Start"),tt&&(tt.style.display="none")},5e3)}function s_(){!nt||!dn||(nt.aspect=window.innerWidth/window.innerHeight,nt.updateProjectionMatrix(),dn.setSize(window.innerWidth,window.innerHeight))}function At(n){Ti.push({timestamp:performance.now(),action:n})}function o_(n){if(!(!ct||!ct.isLocked||ht))switch(n.code){case"KeyW":case"ArrowUp":At(()=>mr=!0);break;case"KeyA":case"ArrowLeft":At(()=>_r=!0);break;case"KeyS":case"ArrowDown":At(()=>gr=!0);break;case"KeyD":case"ArrowRight":At(()=>vr=!0);break;case"ShiftLeft":At(()=>In=!0);break;case"Digit1":At(()=>Or("handgun"));break;case"Digit2":At(()=>Or("sniper"));break;case"Digit3":At(()=>Or("smg"));break;case"KeyR":At(()=>Xg());break}}function a_(n){if(ht){n.code==="ShiftLeft"&&At(()=>In=!1);return}switch(n.code){case"KeyW":case"ArrowUp":At(()=>mr=!1);break;case"KeyA":case"ArrowLeft":At(()=>_r=!1);break;case"KeyS":case"ArrowDown":At(()=>gr=!1);break;case"KeyD":case"ArrowRight":At(()=>vr=!1);break;case"ShiftLeft":At(()=>In=!1);break}}function l_(n){if(!(!ct||!ct.isLocked||ht||!Y))if(n.button===0)if(at==="smg")_n=!0;else{const e=performance.now(),t=lt[at];if(!t||!t.fireRate||e-or<t.fireRate)return;At(()=>{if(ht)return;const i=performance.now();if(i-or<t.fireRate)return;or=i;const r=new C;if(t.muzzlePoint.getWorldPosition(r),Dn[at]<=0||Ri)return;const s=new C;if(nt.getWorldDirection(s),yc(r,s.clone(),at),Dn[at]--,$e==="multiplayer"){const a={muzzlePosition:{x:r.x,y:r.y,z:r.z},direction:{x:s.x,y:s.y,z:s.z},weaponType:at};Ui({type:"shoot",data:a})}t.model&&!di&&(di=!0,Xn=0)})}else n.button===2&&At(()=>Nn=!0)}function c_(n){if(ht){n.button===2&&At(()=>Nn=!1);return}n.button===0?_n&&(_n=!1):n.button===2&&At(()=>Nn=!1)}function yc(n,e,t){if(!ue||!lt[t]||!nt||!Y)return;const i=lt[t],r=e.clone();if(t==="smg"&&i.spreadAngle&&i.projectileMaterial){const l=(Nn||In)&&i.adsSpreadMultiplier!==void 0?i.adsSpreadMultiplier:1,c=i.spreadAngle*l;if(c>.001){const u=nt.quaternion,d=new C(1,0,0).applyQuaternion(u),f=new C(0,1,0).applyQuaternion(u),m=Y.next()*2*Math.PI,g=Math.tan(c/2),_=Y.next()*g,p=Math.cos(m)*_,h=Math.sin(m)*_;r.addScaledVector(d,p),r.addScaledVector(f,h),r.normalize()}}const s=new Re(gc,i.projectileMaterial);s.castShadow=!0,s.position.copy(n);const a={mesh:s,velocity:r.multiplyScalar(i.projectileSpeed),lifeTime:0,spawnTime:performance.now(),weaponType:t};ue.add(a.mesh),yi.push(a)}const Qi=new ko,Dl=new C;function u_(n){if(ue)for(let e=yi.length-1;e>=0;e--){const t=yi[e],i=t.mesh.position.clone();if(t.mesh.position.addScaledVector(t.velocity,n),t.lifeTime+=n,t.lifeTime>pc){ue.remove(t.mesh),t.mesh.geometry&&t.mesh.geometry.dispose(),yi.splice(e,1);continue}Qi.origin.copy(i),Qi.direction.copy(t.mesh.position).sub(i);const r=Qi.direction.length();r>=1e-4&&Qi.direction.normalize();let s=!1;for(const[a,o]of pr.entries()){const c=new Nt().setFromObject(o).clone().expandByScalar(mc);let u=!1;if(r>=1e-4){const d=Qi.intersectBox(c,Dl);d&&i.distanceTo(d)<=r&&(u=!0)}if(u||c.containsPoint(t.mesh.position)){ue.remove(o),o.geometry&&o.geometry.dispose(),o.material&&!Array.isArray(o.material)&&o.material.dispose(),pr.delete(a),s=!0;break}}if(!s&&$e==="multiplayer"&&je&&je.parent){const o=new Nt().setFromObject(je).clone().expandByScalar(Vn);let l=!1;if(r>=1e-4){const c=Qi.intersectBox(o,Dl);c&&i.distanceTo(c)<=r&&(l=!0)}if(l||o.containsPoint(t.mesh.position)){const c=lt[t.weaponType];c&&typeof c.damage=="number"?Ui({type:"hit_opponent",data:{damageDealt:c.damage}}):Ui({type:"hit_opponent",data:{damageDealt:1}}),s=!0,je.traverse(u=>{if(u instanceof Re&&u.material instanceof Ft){const d=u.material.color.getHex();u.material.color.setHex(16711680),setTimeout(()=>{u&&u.material instanceof Ft&&u.material.color.setHex(d)},150)}})}}s&&(ue.remove(t.mesh),t.mesh.geometry&&t.mesh.geometry.dispose(),yi.splice(e,1))}}function d_(n){if(ue)for(let e=sr.length-1;e>=0;e--){const t=sr[e];t.mesh.position.addScaledVector(t.velocity,n),t.lifeTime+=n,t.lifeTime>pc&&(ue.remove(t.mesh),t.mesh.geometry&&t.mesh.geometry.dispose(),sr.splice(e,1))}}function h_(n){if(!nt||!lt[at]||!li||!Hr||!ai||!kr||!Y)return;const e=lt[at],t=e.model,i=Nn||In,r=i?e.adsFov:Yo;nt.fov=vi.lerp(nt.fov,r,Cr*n),nt.updateProjectionMatrix();const s=ai.getObjectByName("sniperScopeMesh");if(at==="sniper"?(li.style.display=i?"block":"none",s&&ai.visible&&(s.visible=!i)):li.style.display="none",di){Xn+=n;let l=0;const c=new C;if(Xn<=e.recoilDuration)if(c.x=(Y.next()-.5)*2*(e.recoilAmount.x||0),c.z=e.recoilAmount.z,at==="sniper"&&i)l=e.recoilAmount.y;else{c.y=e.recoilAmount.y;let f=.015;at==="sniper"?f=.02:at==="smg"&&(f=.025),l=f}const u=e.recoilReturnSpeed*n,d=Xn<=e.recoilDuration?u*2.5:u*1.5;if(hn=vi.lerp(hn,l,d),Mn.lerp(c,d),Xn>e.recoilDuration){const f=Math.abs(hn)<.001&&Math.abs(l)<.001,m=Mn.lengthSq()<1e-5&&c.lengthSq()<1e-5;f&&m&&(di=!1,Xn=0,hn=0,Mn.set(0,0,0))}}else hn=vi.lerp(hn,0,e.recoilReturnSpeed*n*1.5),Mn.lerp(new C(0,0,0),e.recoilReturnSpeed*n*1.5);const a=i?e.adsPosition:e.hipPosition,o=i?e.adsRotation:e.hipRotation;t.position.lerp(a,Cr*n),t.rotation.x=vi.lerp(t.rotation.x,o.x,Cr*n),t.rotation.y=vi.lerp(t.rotation.y,o.y,Cr*n),t.rotation.z=vi.lerp(t.rotation.z,o.z,Cr*n),at==="sniper"&&i?(t.rotation.x+=hn,t.position.x-=Mn.x,t.position.z-=Mn.z):(t.position.x-=Mn.x,t.position.y-=Mn.y,t.position.z-=Mn.z)}function f_(){const n=performance.now();let e=0;for(;e<Ti.length;)n>=Ti[e].timestamp+og?(Ti[e].action(),Ti.splice(e,1)):e++}const Ss=new Nt;function Fo(){if(!Vr||!dn||!ue||!nt||!ct){if($e==="idle"&&Vr&&(!(jt!=null&&jt.style.display)||(jt==null?void 0:jt.style.display)==="flex")){Ee&&!ht&&Xr();return}requestAnimationFrame(Fo);return}if(requestAnimationFrame(Fo),ht){dn.render(ue,nt);return}const n=performance.now(),e=ct.isLocked?Math.min((n-Ps)/1e3,.05):0;if(Ps=n,ct.isLocked){if(f_(),_n&&at==="smg"&&!ht&&Y){const d=lt.smg;if(d&&d.fireRate&&n-or>=d.fireRate){or=n;const f=new C;if(d.muzzlePoint.getWorldPosition(f),Dn.smg<=0||Ri){_n=!1;return}const m=new C;if(nt.getWorldDirection(m),yc(f,m.clone(),"smg"),Dn.smg--,$e==="multiplayer"){const g={muzzlePosition:{x:f.x,y:f.y,z:f.z},direction:{x:m.x,y:m.y,z:m.z},weaponType:"smg"};Ui({type:"shoot",data:g})}d.model&&!di&&(di=!0,Xn=0)}}if(Ri){const d=lt[at];d&&d.reloadTime&&n-Sc>=d.reloadTime&&(Dn[at]=d.magazineCapacity||0,Ri=!1)}const t=ct.getObject(),i=ag*(In||Nn?.6:1);un.x-=un.x*10*e,un.z-=un.z*10*e,Rr.z=Number(mr)-Number(gr),Rr.x=Number(_r)-Number(vr),Rr.normalize(),(mr||gr)&&(un.z-=Rr.z*i*10*e),(_r||vr)&&(un.x-=Rr.x*i*10*e);const r=new C;r.x=un.x*e,r.z=un.z*e;const s=t.position.clone();t.translateX(r.x),Ss.setFromCenterAndSize(new C(t.position.x,s.y-xt/2+Vn,t.position.z),new C(Vn*2,xt-Vn*2,Vn*2));for(const d of St){const f=new Nt().setFromObject(d);if(Ss.intersectsBox(f)){t.position.x=s.x,un.x=0;break}}t.translateZ(r.z),Ss.setFromCenterAndSize(new C(t.position.x,s.y-xt/2+Vn,t.position.z),new C(Vn*2,xt-Vn*2,Vn*2));for(const d of St){const f=new Nt().setFromObject(d);if(Ss.intersectsBox(f)){t.position.z=s.z,un.z=0;break}}const a=t.position.clone();a.y+=xt*.5;const o=new C(0,-1,0),l=new fc(a,o,0,xt*2),c=[qn,...St.filter(d=>new Nt().setFromObject(d).max.y<a.y+xt*.5)],u=l.intersectObjects(c,!1);if(u.length>0){const d=u[0];t.position.y=d.point.y+xt}else t.position.y-=9.81*e*e*2;if(bt){let f=bt.rotation.x-hn;bt.rotation.x=Math.max(-Math.PI/2,Math.min(Math.PI/2,f))}$e==="multiplayer"&&n-Cl>bg&&(i_(),Cl=n)}else if(un.set(0,0,0),bt&&hn!==0){let i=bt.rotation.x-hn;bt.rotation.x=Math.max(-Math.PI/2,Math.min(Math.PI/2,i))}h_(e),u_(e),$e==="multiplayer"&&d_(e),Ec(),dn.render(ue,nt)}Gg();
